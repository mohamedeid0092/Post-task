      ...
      <div class="row tm-row tm-mb-40">
        <div class="col-12">
          <div class="mb-4">
            ...
            <p>
              Etiam vehicula, tortor ac eleifend tincidunt, diam neque
              pellentesque ipsum, a geugiat eros mauris eget lorem. Quisque in
              bibendum elit, in egestas turpis. Vestibulum ornare sollicitudin
              congue. Aliquam lorem mi, maximus at iaculis ut, viverra vel
              mauris. Duis congue luctus metus, sodales tincidunt lectus
              fringilla ut. Nunc tempus at magna sed vestibulum.
            </p>
            <p>
      ...
      <div class="row tm-row tm-mb-60">
        ...
        <div class="col-lg-6 tm-mb-60 tm-person-col">
          <div class="d-flex -flex-row">
            <img src={img2} alt="Image" class="img-fluid mr-4" />
            <div class="mx-5">
        ...
        <div class="col-lg-6 tm-mb-60 tm-person-col">
          <div class="d-flex -flex-row">
            <img src={img2} alt="Image" class=" ml-5" />
            <div class="mx-5">
        ...
        <div class="col-lg-6 tm-mb-60 tm-person-col">
          <div class="d-flex -flex-row ">
            <img src={img2} alt="Image" class=" ml-5" />
            <div class="mx-5">
              <h2 class="tm-color-primary tm-post-title mb-2">
                Catherine Soft
              </h2>
